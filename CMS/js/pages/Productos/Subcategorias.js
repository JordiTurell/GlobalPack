                ...
                if (data.status) {
                    ...
                    for (var a = 0; a < data.list.length; a++) {
                        ...
                        $($($('#listcategorias').children()[a]).find('.switch')[0]).on('click', function (ev) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "/api/interfaces/admin/IProductos.php?fun=ActiveSubCategorias",
                                data: JSON.stringify(request),
                                cache: false,
                                dataType: "json",
                                contentType: "application/json; charset=utf-8",
                        ...
                        $($('#listcategorias').children()[a]).on('click', function () {
                            ...
                            $('#SaveCat').data('id', item.Id_Subcategoria);
                        ...
                        $('#listcategorias').sortable({
                            ...
                            update: function (event, ui) {
                                ...
                                $.ajax({
                                    url: "/api/interfaces/admin/IProductos.php?fun=SortableSubCategoria",
                                    type: "POST",
                                    data: JSON.stringify(request),
                                    cache: false,
                                    dataType: "json",
...
function EditCat(request, upload) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/interfaces/admin/IProductos.php?fun=SaveSubCategoria",
            data: JSON.stringify(request),
            cache: false,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
...
Upload.prototype.doUpload = function () {
    ...
    $.ajax({
        type: "POST",
        url: "/cms/img/UpdateFile.php?FOLDER=icon-subcategoria-producte",
        async: true,
        data: formData,
        cache: false,
        contentType: false,
