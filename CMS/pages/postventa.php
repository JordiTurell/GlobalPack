...
<body class="hold-transition skin-blue sidebar-mini">
            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        Edici&#243;n del apartado de postventa. 
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box">
                            <div class="box-header">
                                <h3>Descripci&#243;n postventa</h3>
                                <i class="fas fa-sort-down" style="float:right; margin-top:-34px; font-size:23px;" onclick="ShowBoxDesc(false)"></i>
                            </div>
                            <div class="box-body" id="descbody">
                                <textarea id="descpostventa" class="form-control"></textarea>
                            </div>
                            <div class="box-footer" id="descfooter">
                                <input type="button" value="Guardar" class="btn" onclick="SaveDEscripcion();" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="box">
                            <div class="box-header">
                                <h3>Planes</h3>
                                <input type="button" class="btn" value="Crear Plan" style="float:right; margin-top:-34px;" onclick="ShowModalCrearPlan();"/>
                            </div>
                            <div class="box-body" id="tableplans">
    ...
    <?php include_once('../Modals/ModalCrearPlan.php'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            LoadDescripcion('<?php echo $ses->token ?>');
        });
    </script>
</body>
</html>
