...
?>
<body class="hold-transition skin-blue sidebar-mini" onload="LoadNosotros('<?php echo $ses->token; ?>');">
    <div class="wrapper">
            ...
            <section class="content">
                <div class="box">
                    <div class="box-header">
                        Edición del apartado Nosotros
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <img src="/cms/img/default.png" style="width: 100%;" onclick="$('#updateimage').click();" id="imagen_nosotros" />
                                <input type="file" onchange="Updatefile(this);" style="display:none;" id="updateimage" />
                            </div>
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn" onclick="saveNosotros('<?php echo $ses->token; ?>');">Guardar</button>
                    </div>
                </div>
            </section>
            <!-- /.content -->
    ...
    <script src="/cms/js/pages/Nosotros_Informacion.js"></script>
</body>
</html>
