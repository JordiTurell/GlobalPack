...
?>
<body class="hold-transition skin-blue sidebar-mini" onload="LoadItems('<?php echo $ses->token; ?>');">
    <div class="wrapper">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6">
                                <div class="input-group" style="height:40px !important;">
                                    ...
                                    <img src="/cms/img/default.png" id="icono" style="width:45px; height:45px; border:solid 1px #d2d6de; border-right:none; cursor:pointer;" onclick="$('#updateicon').click();" />
                                    
                                    <input type="text" class="form-control" id="beneficio_text" placeholder="Texto Beneficio" />
                                    <div class="input-group-addon" style="padding:8px; background-color:#3c8dbc; cursor:pointer; height:45px;" onclick="SaveBeneficio('<?php echo $ses->token; ?>');">
    ...
    <script src="/cms/js/pages/Nosotros_Beneficios.js"></script>
