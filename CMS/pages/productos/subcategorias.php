...
<body class="hold-transition skin-blue sidebar-mini" onload="LoadList('<?php echo $ses->token; ?>');">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <input type="button" class="btn" value="Crear Filtro" style="margin-bottom:10px;" onclick="ReloadForm();" />
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                    ...
                    <div class="col-md-6">
                        <div class="box">
                            <div class="box-header">Crear/Editar Filtros</div>
                            <div class="box-body">
                                <div class="from-group">
                                    <label>Nombre de Filtro</label>
                                    <input type="text" id="Nombre" placeholder="Nombre del Filtro" class="form-control" />
                                </div>
                                <br />
                                <div class="from-group">
                                ...
                                <br />
                                <input type="button" value="Guardar Filtro" id="SaveCat" class="btn" data-id="00000000-0000-0000-0000-000000000000" onclick="SaveCategoria('<?php echo $ses->token; ?>');" />
                            </div>
                            <div class="box-footer"></div>
                        </div>
                    </div>
    ...
    <script src="/cms/js/pages/Productos/Subcategorias.js"></script>
</body>
</html>
