...
?>
<body class="hold-transition skin-blue sidebar-mini" onload="LoadTerminosCondiciones('<?php echo $ses->token; ?>', 4);">
    <div class="wrapper">
            ...
            <section class="content">
                <div class="box">
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn" onclick="SaveTerminosCondiciones('<?php echo $ses->token; ?>', 4);">Guardar</button>
                    </div>
                </div>
            </section>
            <!-- /.content -->
